...
const SECTIONS: { h: string; b: string }[] = [
  ...
  { h: '🛡️  Defense = concentration', b: 'A cell’s defense is your army spread over your border. Fewer borders (or more army) = a harder shell. A huge empire with a long frontier is thin everywhere — mass on one point and break through.' },
  ...
  { h: '🎯  Attack & Hold', b: 'Tap a country to attack it — ONE strike that sends your chosen %: 25% safe · 50% normal · 75% aggressive · All-in risky. More % = a stronger hit but leaves you weaker; tap again to keep hitting. Battles hit only the SHARED BORDER, not the whole country. Between attacks you\'re in Hold: +25% defence, and your army rebuilds from income.' },
