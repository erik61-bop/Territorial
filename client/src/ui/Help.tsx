...
const SECTIONS: { h: string; b: string }[] = [
  ...
  { h: '🎯  Attack & Hold', b: 'Tap a country to keep attacking it (a standing order keeps your army flowing there). Pick how much to send: 25% safe · 50% normal · 75% aggressive · All-in risky — more power, but it leaves you weaker. Battles hit only the SHARED BORDER, not the whole country. Press Hold to stop and dig in: +25% defence (and your army rebuilds).' },
